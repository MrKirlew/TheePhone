...
class OrchestratorAgent(BaseAgent):
    ...
    Enhanced orchestrator:
      ...
      3. Execute steps:
         - perception
         - memory summary
         - workspace tools (docs, sheets, drive, gmail, calendar, contacts)
    ...
    State:
      ...
      memory_context, workspace_response, interim_response, reflection_result, final_response.
    """
    ...
    def __init__(
        ...
        sub_agents = [
            ...
            conversation_agent, perception_agent, memory_agent, workspace_agent
        ]
        super().__init__(
        ...
        for step in steps:
            ...
            if action == "perception" and state.get("image_context"):
                ...
                async for ev in self.memory_agent.run_async(ctx):
                    yield ev
            elif action == "workspace_tools":
                # Check if workspace context is needed or available
                async for ev in self.workspace_agent.run_async(ctx):
                    yield ev
